...
<IframeEmbed
  src="/visualizations/collab-recsys-matrix-factorization.html"
  minHeight={760}
  title="协同过滤矩阵分解可视化"
/>

<IframeEmbed
  src="/visualizations/collab-recsys-cost-surface.html"
  minHeight={760}
  title="协同过滤成本曲面直觉"
/>

<IframeEmbed
  src="/visualizations/collab-recsys-topn-explorer.html"
  minHeight={760}
  title="协同过滤 TopN 结果探索"
/>
