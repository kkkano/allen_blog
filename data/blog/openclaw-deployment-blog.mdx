...
用的是 [OpenClaw](https://github.com/nicepkg/openclaw)，最近很火的龙虾Bot。
...
3. **记忆 GitHub 同步**：定时把容器内的记忆文件推送到 GitHub 仓库，实现 Telegram Bot 和 Claude Code 的双向同步
