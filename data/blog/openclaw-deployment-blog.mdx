...
Bot memory export: D:/openclaw-memory/telegram-bot/export/memory-export.md
Bot config: D:/openclaw-memory/shared/config-sanitized.json
```

这样 Claude Code 启动时就能读到 Bot 最新的记忆状态了。
