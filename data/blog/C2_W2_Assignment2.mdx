...
<IframeEmbed
  src="/static/html/softmax_visualization.html"
  minHeight={820}
  title="Softmax概率分布可视化"
/>
...
<IframeEmbed
  src="/static/html/multiclass_training_animation.html"
  minHeight={920}
  title="多分类训练过程动画"
/>
...
<IframeEmbed
  src="/static/html/multiclass_decision_boundary.html"
  minHeight={860}
  title="决策边界3D可视化"
/>
...
- $N$ 是样本数量
- $K$ 是类别数量（这里是10）
- $y_{ij}$ 是真实标签的one-hot编码
- $\hat{y}_{ij}$ 是Softmax输出的预测概率
