...
<iframe
  ...
  width="100%"
  scrolling="no"
  style={{ border: 'none', borderRadius: '12px', display: 'block', minHeight: '600px' }}
  onLoad={(e) => { e.target.style.height = (e.target.contentDocument.documentElement.scrollHeight || 800) + 'px' }}
/>
...
<iframe
  ...
  scrolling="no"
  style={{ border: 'none', borderRadius: '12px', display: 'block', minHeight: '600px' }}
  onLoad={(e) => { e.target.style.height = (e.target.contentDocument.documentElement.scrollHeight || 800) + '
