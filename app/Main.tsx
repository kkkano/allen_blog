    ...
    <>
      <div className="divide-y divide-gray-200 dark:divide-gray-700">
        ...
        <div className="space-y-6 pb-10 pt-8 md:space-y-8">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-white/80 via-[#fafcff] to-[#f5f9ff] p-8 dark:from-[#030711] dark:via-[#0c1221] dark:to-[#111725] md:p-12 [.gradient_&]:from-[#f7fbff] [.gradient_&]:via-[#eef4ff] [.gradient_&]:to-[#ecf1ff] dark:[.gradient_&]:from-[#05060f] dark:[.gradient_&]:via-[#0d1425] dark:[.gradient_&]:to-[#151b31]">
